    ...
    public SecurityFilterChain securityfilterchain (HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authRequests->
                ...
                .requestMatchers("/RegistroHerramientas","/PrincipalProveedor").hasAuthority("Proveedor")
                .requestMatchers("/admin_reporte","/admin_registrar","/admin_historial","/admin_herramienta","/admin_eliminar","/admin_devolucion","/admin_reporte").hasAuthority("Administrador")
